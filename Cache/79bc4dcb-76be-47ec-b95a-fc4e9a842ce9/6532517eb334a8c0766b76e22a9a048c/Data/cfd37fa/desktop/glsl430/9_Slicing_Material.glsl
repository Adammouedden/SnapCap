...
float l9_6=min(min(clamp(maxBorderSize,0.0,1.0),l9_5.x/2.0),l9_5.y/2.0);
...
{
l9_67=clamp(l9_16.w*2.0,0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_68=clamp(dot(l9_16.xyz,vec3(l9_16.w)),0.0,1.0);
}
#else
{
float l9_69;
...
{
l9_70=(1.0-dot(l9_16.xyz,vec3(0.33333001)))*l9_16.w;
}
#else
{
float l9_71;
...
{
l9_71=(1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0))*l9_16.w;
}
#else
{
float l9_72;
...
{
l9_72=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_73;
#if (sc_BlendMode_Add)
{
l9_73=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_74;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_74=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_75;
...
{
l9_75=dot(l9_16.xyz,vec3(0.33333001))*l9_16.w;
}
#else
{
float l9_76;
#if (sc_BlendMode_Min)
{
l9_76=1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_77;
#if (sc_BlendMode_Max)
{
l9_77=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_77=1.0;
...
#endif
l9_65=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_16.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_66);
}
#else
{
vec4 l9_78;
...
#endif
vec3 l9_89=mix(l9_87.xyz,definedBlend(l9_87.xyz,l9_16.xyz).xyz,vec3(l9_16.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_91=vec4(mix(vec3(1.0),l9_16.xyz,vec3(l9_16.w)),l9_16.w);
}
#else
{
vec4 l9_92;
...
#endif
l9_92=vec4(l9_16.xyz*l9_93,l9_93);
}
#else
{
l9_92=l9_16;
