...
float l9_4=min(min(clamp(maxBorderSize,0.0,1.0),l9_3.x/2.0),l9_3.y/2.0);
...
{
if (l9_37.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_40=clamp(l9_37.w*2.0,0.0,1.0);
}
#else
{
float l9_41;
...
{
l9_41=clamp(dot(l9_37.xyz,vec3(l9_37.w)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_37.xyz,vec3(0.33333001)))*l9_37.w;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0))*l9_37.w;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*l9_37.w;
}
#else
{
float l9_46;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*l9_37.w;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_37.xyz,vec3(0.33333001))*l9_37.w;
}
#else
{
float l9_49;
...
#endif
vec3 l9_61=mix(l9_59.xyz,definedBlend(l9_59.xyz,l9_37.xyz).xyz,vec3(l9_37.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_63=vec4(mix(vec3(1.0),l9_37.xyz,vec3(l9_37.w)),l9_37.w);
}
#else
{
vec4 l9_64;
